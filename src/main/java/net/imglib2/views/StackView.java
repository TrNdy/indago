...
public class StackView< T > extends AbstractInterval implements RandomAccessibleInterval< T >
{
	...
	public static enum StackAccessMode
	{
		 ...
		 * <em>(n+1)</em>th, this position change is applied to the active
		 * slice {@link RandomAccess}. When changing the <em>(n+1)</em>th
		 * dimension of the position, a new slice {@link RandomAccess} becomes
		 * active is set to the position of the previously active slice
		 * {@link RandomAccess}.
		 */
		DEFAULT,
