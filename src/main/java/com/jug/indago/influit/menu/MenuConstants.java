package com.jug.indago.influit.menu;
...
public final class MenuConstants {
	...
	public static final String FILE_LABEL = "Influit";
	...
	public static final char FILE_MNEMONIC = 'i';
	public static final char EDIT_MNEMONIC = 'e';
	public static final char NODES_MNEMONIC = 'n';
